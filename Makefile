...
CLASS_PATH=$(CLASSPATH):$(HOME)/kaffe/share/kaffe/Klasses.jar:$(HOME)/src/Jap/swingall.jar:$(HOME)/src/Jap/xml.jar:$(HOME)/src/Jap/http.jar:$(HOME)/src/Jap/MRJClasses.zip:$(HOME)/src/Jap/
JAVAC=javac
all:
