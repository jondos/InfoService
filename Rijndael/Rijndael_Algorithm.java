...
//
// $Log$
// Revision 1.3  2003/04/27 12:25:40  sk13
// Some Update enhancements
//
...
//...........................................................................
		 ...
		 */
		public static void
		blockEncrypt (byte[] in, byte[] out, Object sessionKey) {
		 ...
		 //   int ROUNDS = Ke.length - 1;
				...
				int t2   = ((in[8] & 0xFF) << 24 |
										...
										(in[10] & 0xFF) <<  8 |
										(in[11] & 0xFF)        ) ^ Ker[2];
				int t3   = ((in[12] & 0xFF) << 24 |
										(in[13] & 0xFF) << 16 |
										(in[14] & 0xFF) <<  8 |
										(in[15] & 0xFF)        ) ^ Ker[3];

				int a0, a1, a2, a3;
				for (int r = 1; r < 10/*ROUNDS*/; r++) {          // apply round transforms
						Ker = Ke[r];
						a0   = (T1[(t0 >>> 24) & 0xFF] ^
										T2[(t1 >>> 16) & 0xFF] ^
										T3[(t2 >>>  8) & 0xFF] ^
				...
				Ker = Ke[10/*ROUNDS*/];
				int tt = Ker[0];
				out[ 0] = (byte)(S[(t0 >>> 24) & 0xFF] ^ (tt >>> 24));
				out[ 1] = (byte)(S[(t1 >>> 16) & 0xFF] ^ (tt >>> 16));
				out[ 2] = (byte)(S[(t2 >>>  8) & 0xFF] ^ (tt >>>  8));
				out[ 3] = (byte)(S[ t3         & 0xFF] ^  tt        );
				tt = Ker[1];
				out[ 4] = (byte)(S[(t1 >>> 24) & 0xFF] ^ (tt >>> 24));
				out[ 5] = (byte)(S[(t2 >>> 16) & 0xFF] ^ (tt >>> 16));
				out[ 6] = (byte)(S[(t3 >>>  8) & 0xFF] ^ (tt >>>  8));
				out[ 7] = (byte)(S[ t0         & 0xFF] ^  tt        );
				tt = Ker[2];
				out[ 8] = (byte)(S[(t2 >>> 24) & 0xFF] ^ (tt >>> 24));
				out[ 9] = (byte)(S[(t3 >>> 16) & 0xFF] ^ (tt >>> 16));
				out[10] = (byte)(S[(t0 >>>  8) & 0xFF] ^ (tt >>>  8));
				out[11] = (byte)(S[ t1         & 0xFF] ^  tt        );
				tt = Ker[3];
				out[12] = (byte)(S[(t3 >>> 24) & 0xFF] ^ (tt >>> 24));
				out[13] = (byte)(S[(t0 >>> 16) & 0xFF] ^ (tt >>> 16));
				out[14] = (byte)(S[(t1 >>>  8) & 0xFF] ^ (tt >>>  8));
				out[15] = (byte)(S[ t2         & 0xFF] ^  tt        );
				//return result;
		}
...
//...........................................................................
		 ...
		 *
		 * @param key        The 128-bit user-key to use.
		 * @param offset      The offset in the key byte array
		 * @exception  InvalidKeyException  If the key is invalid.
		 */
		public static synchronized Object makeKey (byte[] ky,int offset)
		throws InvalidKeyException {
			if (ky == null)
			 ...
			 //      throw new InvalidKeyException("Incorrect key length");
				int ROUNDS = 10;// 10 round for 16 byte key and 16 byte block getRounds(keySize, blockSize);
				int BC = blockSize / 4;
