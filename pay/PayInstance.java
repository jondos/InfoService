...
public class PayInstance
{
    ...
    private XMLTransCert charge(String accountcert, RSAKeyParameters privKey, String type) throws IOException
    {
        try
        {
            ...
            rootCerts.init();
            AsymmetricKeyParameter testkey = rootCerts.getPublicKey("test server");
    ...
    public XMLBalConf getBalance(String accountcert, RSAKeyParameters privKey) throws IOException
    {
        ...
        try
        {
            ...
            int index = answer.indexOf("<Confirmations>");
            if (index>0)
            {
            ...
            XMLSignature sig = new XMLSignature(xmlBalance.getXMLString(false).getBytes());
        ...
        return new XMLBalConf(xmlBalance, xmlConfirms);
    }
